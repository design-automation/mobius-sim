var mobius_sim = (function (exports, lodash, three, mathjs, proj4) {
    'use strict';
    ...
    var mathjs__namespace = /*#__PURE__*/_interopNamespace(mathjs);
    ...
    })(exports.EEntType || (exports.EEntType = {}));
    // Must match types of entities
    exports.EEntTypeStr = void 0;
    ...
    })(exports.EEntTypeStr || (exports.EEntTypeStr = {}));
    // Must match types of entities
    // Must also match interface IGeomMaps
    exports.EEntStrToGeomMaps = void 0;
    ...
    })(exports.EEntStrToGeomMaps || (exports.EEntStrToGeomMaps = {}));
    // Names of attributes
    exports.EAttribNames = void 0;
    ...
    })(exports.EAttribNames || (exports.EAttribNames = {}));
    // Wire Type
    exports.EWireType = void 0;
    (function (EWireType) {
        EWireType["PLINE"] = "pline";
        EWireType["PGON"] = "pgon";
        EWireType["PGON_HOLE"] = "pgon_hole";
    })(exports.EWireType || (exports.EWireType = {}));
    // The types of operators that can be used in a filter.
    exports.EFilterOperatorTypes = void 0;
    ...
    })(exports.EAttribPush || (exports.EAttribPush = {}));
    // enums
    exports.EAttribDataTypeStrs = void 0;
    ...
    })(exports.EAttribDataTypeStrs || (exports.EAttribDataTypeStrs = {}));
    const RE_SPACES = /\s+/g;
    ...
    function getEntTypeStr(ent_type_str) {
        switch (ent_type_str) {
            case exports.EEntType.POSI:
                return 'positions';
            case exports.EEntType.VERT:
                return 'vertices';
            case exports.EEntType.TRI:
                return 'triangles';
            case exports.EEntType.EDGE:
                return 'edges';
            case exports.EEntType.WIRE:
                return 'wires';
            case exports.EEntType.POINT:
                return 'points';
            case exports.EEntType.PLINE:
                return 'polylines';
            case exports.EEntType.PGON:
                return 'polygons';
            case exports.EEntType.COLL:
                return 'collections';
        }
    }
    function isXYZ(data) {
    ...
    ID_REV_MAP.set(exports.EEntType.POSI, new Map());
    ID_REV_MAP.set(exports.EEntType.VERT, new Map());
    ID_REV_MAP.set(exports.EEntType.EDGE, new Map());
    ID_REV_MAP.set(exports.EEntType.WIRE, new Map());
    ID_REV_MAP.set(exports.EEntType.POINT, new Map());
    ID_REV_MAP.set(exports.EEntType.PLINE, new Map());
    ID_REV_MAP.set(exports.EEntType.PGON, new Map());
    ID_REV_MAP.set(exports.EEntType.COLL, new Map());
    // ============================================================================
    function idMake(ent_type, ent_i) {
        ...
        const new_id = exports.EEntTypeStr[ent_type] + ent_i;
    ...
    function isTopo(ent_type) {
        if (ent_type === exports.EEntType.VERT) {
            return true;
        }
        if (ent_type === exports.EEntType.EDGE) {
            return true;
        }
        if (ent_type === exports.EEntType.WIRE) {
            return true;
        }
        return false;
    }
    function isObj(ent_type) {
        if (ent_type === exports.EEntType.PGON) {
            return true;
        }
        if (ent_type === exports.EEntType.PLINE) {
            return true;
        }
        if (ent_type === exports.EEntType.POINT) {
            return true;
        }
        return false;
    }
    function isDim0(ent_type) {
        if (ent_type === exports.EEntType.POSI) {
            return true;
        }
        if (ent_type === exports.EEntType.VERT) {
            return true;
    ...
    class GIAttribMapBase {
        ...
        getDataLength() {
            switch (this._data_type) {
                case exports.EAttribDataTypeStrs.NUMBER:
                case exports.EAttribDataTypeStrs.STRING:
                case exports.EAttribDataTypeStrs.BOOLEAN:
                    return 1;
                case exports.EAttribDataTypeStrs.LIST:
                    let max_len = 0;
                    for (const val_i of this._map_val_i_to_ents_i.keys()) {
                    ...
                    return max_len;
                case exports.EAttribDataTypeStrs.DICT:
                    let max_size = 0;
                    for (const val_i of this._map_val_i_to_ents_i.keys()) {
        ...
        _mergeConflictError(other_ent_i, other_val_i) {
            ...
            if (this._ent_type === exports.EEntType.POSI && this._name === 'xyz') {
                const verts_i = this.modeldata.geom.nav.navPosiToVert(other_ent_i);
                const parent_obj_strs = [];
                for (const vert_i of verts_i) {
                    const parent_obj = this.modeldata.geom.query.getTopoObj(exports.EEntType.VERT, vert_i);
            ...
            else if (this._ent_type > exports.EEntType.POSI && this._ent_type < exports.EEntType.POINT) {
        ...
        _compare(operator, val1, val2) {
            ...
            switch (operator) {
                // ==
                case exports.EFilterOperatorTypes.IS_EQUAL:
                    return val1 === val2;
                // !=
                case exports.EFilterOperatorTypes.IS_NOT_EQUAL:
                    return val1 !== val2;
                // >
                case exports.EFilterOperatorTypes.IS_GREATER:
                    return val1 > val2;
                // >=
                case exports.EFilterOperatorTypes.IS_GREATER_OR_EQUAL:
                    return val1 >= val2;
                // <
                case exports.EFilterOperatorTypes.IS_LESS:
                    return val1 < val2;
                // <=
                case exports.EFilterOperatorTypes.IS_LESS_OR_EQUAL:
                    return val1 <= val2;
                default:
    ...
    class GIAttribMapBool extends GIAttribMapBase {
        ...
        queryVal(ents_i, operator, search_val) {
            ...
            if (search_val === null) {
                if (operator !== exports.EFilterOperatorTypes.IS_EQUAL && operator !== exports.EFilterOperatorTypes.IS_NOT_EQUAL) {
                    {
        ...
        _searchBoolVal(ents_i, operator, search_val) {
            ...
            if (search_val === null && operator === exports.EFilterOperatorTypes.IS_EQUAL) {
                return this.getEntsWithoutVal(ents_i);
            }
            else if (search_val === null && operator === exports.EFilterOperatorTypes.IS_NOT_EQUAL) {
    ...
    class GIAttribsAdd {
        ...
        addAttrib(ent_type, name, data_type) {
            if (ent_type === exports.EEntType.MOD) {
    ...
    class GIAttribsQuery {
        ...
        hasModelAttrib(name) {
            const ssid = this.modeldata.active_ssid;
            const attribs_maps_key = exports.EEntTypeStr[exports.EEntType.MOD];
        ...
        getAttribDataType(ent_type, name) {
            ...
            if (ent_type === exports.EEntType.MOD) {
                ...
                if (typeof value === 'number') {
                    return exports.EAttribDataTypeStrs.NUMBER;
                }
                else if (typeof value === 'string') {
                    return exports.EAttribDataTypeStrs.STRING;
                }
                else if (typeof value === 'boolean') {
                    return exports.EAttribDataTypeStrs.BOOLEAN;
                }
                else if (Array.isArray(value)) {
                    return exports.EAttribDataTypeStrs.LIST;
                }
                else if (typeof value === 'object') {
                    return exports.EAttribDataTypeStrs.DICT;
                }
        ...
        sortByAttribs(ent_type, ents_i, name, idx_or_key, method) {
            ...
            function _sortCompareVals(ent1_i, ent2_i) {
                ...
                if (method === exports.ESort.DESCENDING) {
                    if (val1 < val2) {
                        return 1;
                    }
                    if (val1 > val2) {
            ...
            // do the sort
            if (attrib.getDataType() === exports.EAttribDataTypeStrs.LIST) {
            ...
            else if (attrib.getDataType() === exports.EAttribDataTypeStrs.DICT) {
                if (idx_or_key === null || idx_or_key === undefined) {
    ...
    class GIAttribsMerge {
        ...
        merge(ssid, exist_ssid) {
            this._mergeEntAttribs(ssid, exist_ssid, exports.EEntType.POSI);
            this._mergeEntAttribs(ssid, exist_ssid, exports.EEntType.VERT);
            this._mergeEntAttribs(ssid, exist_ssid, exports.EEntType.EDGE);
            this._mergeEntAttribs(ssid, exist_ssid, exports.EEntType.WIRE);
            this._mergeEntAttribs(ssid, exist_ssid, exports.EEntType.POINT);
            this._mergeEntAttribs(ssid, exist_ssid, exports.EEntType.PLINE);
            this._mergeEntAttribs(ssid, exist_ssid, exports.EEntType.PGON);
            this._mergeEntAttribs(ssid, exist_ssid, exports.EEntType.COLL);
         ...
         */
        add(ssid, exist_ssid) {
            this._addEntAttribs(ssid, exist_ssid, exports.EEntType.POSI);
            this._addEntAttribs(ssid, exist_ssid, exports.EEntType.VERT);
            this._addEntAttribs(ssid, exist_ssid, exports.EEntType.EDGE);
            this._addEntAttribs(ssid, exist_ssid, exports.EEntType.WIRE);
            this._addEntAttribs(ssid, exist_ssid, exports.EEntType.POINT);
            this._addEntAttribs(ssid, exist_ssid, exports.EEntType.PLINE);
            this._addEntAttribs(ssid, exist_ssid, exports.EEntType.PGON);
            this._addEntAttribs(ssid, exist_ssid, exports.EEntType.COLL);
            this._mergeModelAttribs(ssid, exist_ssid);
        }
        // ============================================================================
        // Private methods
        ...
        _mergeModelAttribs(ssid, exist_ssid) {
            const other_attribs = this.modeldata.attribs.attribs_maps.get(exist_ssid)[exports.EEntTypeStr[exports.EEntType.MOD]];
            const this_attribs = this.modeldata.attribs.attribs_maps.get(ssid)[exports.EEntTypeStr[exports.EEntType.MOD]];
            ...
            other_attribs.forEach((val, key) => {
                this_attribs.set(key, lodash__default["default"].cloneDeep(val));
            });
        }
        /**
        ...
        _mergeEntAttribs(ssid, other_ssid, ent_type) {
            const other_attribs = this.modeldata.attribs.attribs_maps.get(other_ssid)[exports.EEntTypeStr[ent_type]];
            const this_attribs = this.modeldata.attribs.attribs_maps.get(ssid)[exports.EEntTypeStr[ent_type]];
    ...
    class GIAttribsSnapshot {
        ...
        addSnapshot(ssid, include) {
            ...
            attribs.ps.set(exports.EAttribNames.COORDS, new GIAttribMapList(this.modeldata, exports.EAttribNames.COORDS, exports.EEntType.POSI, exports.EAttribDataTypeStrs.LIST));
            attribs._v.set(exports.EAttribNames.COLOR, new GIAttribMapList(this.modeldata, exports.EAttribNames.COLOR, exports.EEntType.VERT, exports.EAttribDataTypeStrs.LIST));
            attribs._v.set(exports.EAttribNames.NORMAL, new GIAttribMapList(this.modeldata, exports.EAttribNames.NORMAL, exports.EEntType.VERT, exports.EAttribDataTypeStrs.LIST));
            // add attributes for time stamps
            attribs.pt.set(exports.EAttribNames.TIMESTAMP, new GIAttribMapNum(this.modeldata, exports.EAttribNames.TIMESTAMP, exports.EEntType.POINT, exports.EAttribDataTypeStrs.NUMBER));
            attribs.pl.set(exports.EAttribNames.TIMESTAMP, new GIAttribMapNum(this.modeldata, exports.EAttribNames.TIMESTAMP, exports.EEntType.PLINE, exports.EAttribDataTypeStrs.NUMBER));
            attribs.pg.set(exports.EAttribNames.TIMESTAMP, new GIAttribMapNum(this.modeldata, exports.EAttribNames.TIMESTAMP, exports.EEntType.PGON, exports.EAttribDataTypeStrs.NUMBER));
            // add attributes for collections
            attribs.co.set(exports.EAttribNames.COLL_NAME, new GIAttribMapStr(this.modeldata, exports.EAttribNames.COLL_NAME, exports.EEntType.COLL, exports.EAttribDataTypeStrs.STRING));
            // merge data
        ...
        copyEntsToActiveSnapshot(from_ssid, ents) {
            ...
            for (const [ent_type, ent_i] of ents) {
                const attribs = from_attrib_maps[exports.EEntTypeStr[ent_type]];
    ...
    class GIAttribsThreejs {
        ...
        get3jsSeqPosisCoords(ssid) {
            const coords_attrib = this.modeldata.attribs.attribs_maps.get(ssid).ps.get(exports.EAttribNames.COORDS);
            //
            const coords = [];
            const posi_map = new Map();
            const posis_i = this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.POSI);
        ...
        get3jsSeqVertsCoords(ssid) {
            ...
            const verts_i = this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.VERT);
            for (const vert_i of verts_i) {
        ...
        get3jsSeqVertsNormals(ssid) {
            if (!this.modeldata.attribs.attribs_maps.get(ssid)._v.has(exports.EAttribNames.NORMAL)) {
                return null;
            }
            // create a sparse arrays of normals of all verts of polygons
            const verts_attrib = this.modeldata.attribs.attribs_maps.get(ssid)._v.get(exports.EAttribNames.NORMAL);
            const normals = [];
            const pgons_i = this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.PGON);
            for (const pgon_i of pgons_i) {
                let pgon_normal = null;
                for (const vert_i of this.modeldata.geom.nav.navAnyToVert(exports.EEntType.PGON, pgon_i)) {
        ...
        get3jsSeqVertsColors(ssid) {
            if (!this.modeldata.attribs.attribs_maps.get(ssid)._v.has(exports.EAttribNames.COLOR)) {
                return null;
            }
            const verts_attrib = this.modeldata.attribs.attribs_maps.get(ssid)._v.get(exports.EAttribNames.COLOR);
            // get all the colors
            const verts_colors = [];
            const verts_i = this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.VERT);
            for (const vert_i of verts_i) {
        ...
        getAttribsForTable(ssid, ent_type) {
            ...
            for (const ent_i of ents_i) {
                ...
                if (ent_type === exports.EEntType.COLL) {
                ...
                for (const ent_i of ents_i) {
                    if (attrib_name.substr(0, 1) === '_' && attrib_name !== '_parent') {
                        ...
                        if (attrib_value && attrib_value.constructor === {}.constructor) {
                            ...
                            if (ent_type === exports.EEntType.POSI && Array.isArray(attrib_value)) {
                                if (attrib_name === 'xyz') {
        ...
        getEntSubAttribsForTable(ssid, ent_type, ent_i, level) {
            ...
            switch (ent_type) {
                case exports.EEntType.COLL:
                    {
                        this.modeldata.geom.snapshot.getCollPgons(ssid, ent_i).forEach(pgon_i => data.push(this._addEntSubAttribs(ssid, exports.EEntType.PGON, pgon_i, level)));
                        this.modeldata.geom.snapshot.getCollPlines(ssid, ent_i).forEach(pline_i => data.push(this._addEntSubAttribs(ssid, exports.EEntType.PLINE, pline_i, level)));
                        this.modeldata.geom.snapshot.getCollPoints(ssid, ent_i).forEach(point_i => data.push(this._addEntSubAttribs(ssid, exports.EEntType.POINT, point_i, level)));
                        this.modeldata.geom.snapshot.getCollChildren(ssid, ent_i).forEach(child_coll_i => data.push(this._addEntSubAttribs(ssid, exports.EEntType.COLL, child_coll_i, level)));
                    }
                    return data;
                case exports.EEntType.PGON:
                    {
                ...
                case exports.EEntType.POINT:
                    {
                        ...
                        data.push(this._addEntSubAttribs(ssid, exports.EEntType.VERT, vert_i, level));
                        data.push(this._addEntSubAttribs(ssid, exports.EEntType.POSI, this.modeldata.geom.nav.navVertToPosi(vert_i), level));
                    }
                    return data;
            }
        }
        _addEntSubWire(ssid, wire_i, data, level) {
            data.push(this._addEntSubAttribs(ssid, exports.EEntType.WIRE, wire_i, level));
            ...
            for (const edge_i of edges_i) {
                ...
                data.push(this._addEntSubAttribs(ssid, exports.EEntType.VERT, vert0_i, level));
                data.push(this._addEntSubAttribs(ssid, exports.EEntType.POSI, posi0_i, level));
                data.push(this._addEntSubAttribs(ssid, exports.EEntType.EDGE, edge_i, level));
                if (edge_i === edges_i[edges_i.length - 1]) {
                    const posi1_i = this.modeldata.geom.nav.navVertToPosi(vert1_i);
                    data.push(this._addEntSubAttribs(ssid, exports.EEntType.VERT, vert1_i, level));
                    data.push(this._addEntSubAttribs(ssid, exports.EEntType.POSI, posi1_i, level));
                }
            }
        }
    ...
    class GIAttribsImpExp {
        ...
        importGI(gi_attribs_data, renum_maps) {
            ...
            for (const gi_attrib_data of gi_attribs_data.posis) {
                this._importEntAttribData(gi_attrib_data, exports.EEntType.POSI, renum_maps.posis);
            }
            // vertices
            for (const gi_attrib_data of gi_attribs_data.verts) {
                this._importEntAttribData(gi_attrib_data, exports.EEntType.VERT, renum_maps.verts);
            }
            // edges
            for (const gi_attrib_data of gi_attribs_data.edges) {
                this._importEntAttribData(gi_attrib_data, exports.EEntType.EDGE, renum_maps.edges);
            }
            // wires
            for (const gi_attrib_data of gi_attribs_data.wires) {
                this._importEntAttribData(gi_attrib_data, exports.EEntType.WIRE, renum_maps.wires);
            }
            // points
            for (const gi_attrib_data of gi_attribs_data.points) {
                this._importEntAttribData(gi_attrib_data, exports.EEntType.POINT, renum_maps.points);
            }
            // plines
            for (const gi_attrib_data of gi_attribs_data.plines) {
                this._importEntAttribData(gi_attrib_data, exports.EEntType.PLINE, renum_maps.plines);
            }
            // pgons
            for (const gi_attrib_data of gi_attribs_data.pgons) {
                this._importEntAttribData(gi_attrib_data, exports.EEntType.PGON, renum_maps.pgons);
            }
            // colls
            for (const gi_attrib_data of gi_attribs_data.colls) {
                ...
                // need to be merged ?
                //
                this._importEntAttribData(gi_attrib_data, exports.EEntType.COLL, renum_maps.colls);
            }
            // model
    ...
    class GIAttribsSetVal {
        ...
        setEntAttribVal(ent_type, ent_i, name, value) {
            const ssid = this.modeldata.active_ssid;
            const attrib = this.modeldata.attribs.attribs_maps.get(ssid)[exports.EEntTypeStr[ent_type]].get(name);
            if (attrib === undefined) {
        ...
        setEntsAttribListIdxVal(ent_type, ents_i, name, idx, value) {
            ...
            ents_i = Array.isArray(ents_i) ? ents_i : [ents_i];
            for (const ent_i of ents_i) {
                const data = lodash__default["default"].cloneDeep(attrib.getEntVal(ent_i)); // this will be a deep copy of the data
                data[idx] = value;
        ...
        setEntsAttribDictKeyVal(ent_type, ents_i, name, key, value) {
            ...
            if (attrib.getDataType() !== exports.EAttribDataTypeStrs.DICT) {
                throw new Error('Attribute is not a dictionary, so keyed values are not allowed.');
            }
            // replace the data
            ents_i = Array.isArray(ents_i) ? ents_i : [ents_i];
    ...
    function vecCross(v1, v2, norm = false) {
        const n = mathjs__namespace.cross(v1, v2);
        if (norm) {
            return vecNorm(n);
        }
        return n;
    ...
    function vecDot(v1, v2) {
        return mathjs__namespace.dot(v1, v2);
    }
    function vecNorm(v) {
    ...
    function vecRot(vec, axis, ang) {
        const vec_tjs = new three__namespace.Vector3(...vec);
        const axis_tjs = new three__namespace.Vector3(...axis);
    ...
    function vecAng(v1, v2) {
        ...
        const d = mathjs__namespace.dot(v1n, v2n);
    ...
    function vecAng2(v1, v2, n) {
        ...
        const c = mathjs__namespace.cross(v1n, v2n);
        angle = angle * mathjs__namespace.compare(mathjs__namespace.dot(n, c), 0);
        if (angle < 0) {
    ...
    function vecCodir(v1, v2) {
        v1 = vecNorm(v1);
        v2 = vecNorm(v2);
        if (Math.abs(1 - mathjs__namespace.dot(v1, v2)) > EPS$1) {
            return false;
        }
        return true;
    }
    function dist(p1, p2) {
        return mathjs__namespace.distance(p1, p2);
    }
    /**
    ...
    class GIAttribsPosis {
        ...
        getPosiCoords(posi_i) {
            const ssid = this.modeldata.active_ssid;
            const result = this.modeldata.attribs.attribs_maps.get(ssid).ps.get(exports.EAttribNames.COORDS).getEntVal(posi_i);
            return result;
        }
        /**
        ...
        getVertCoords(vert_i) {
            const ssid = this.modeldata.active_ssid;
            const posi_i = this.modeldata.geom.nav.navVertToPosi(vert_i);
            return this.modeldata.attribs.attribs_maps.get(ssid).ps.get(exports.EAttribNames.COORDS).getEntVal(posi_i);
        }
        /**
        ...
        getEntCoords(ent_type, ent_i) {
            ...
            const coords_map = this.modeldata.attribs.attribs_maps.get(ssid).ps.get(exports.EAttribNames.COORDS);
        ...
        setPosiCoords(index, xyz) {
            const ssid = this.modeldata.active_ssid;
            this.modeldata.attribs.attribs_maps.get(ssid).ps.get(exports.EAttribNames.COORDS).setEntVal(index, xyz);
        }
        /**
        ...
        movePosiCoords(index, xyz) {
            const ssid = this.modeldata.active_ssid;
            const old_xyz = this.modeldata.attribs.attribs_maps.get(ssid).ps.get(exports.EAttribNames.COORDS).getEntVal(index);
            const new_xyz = vecAdd(old_xyz, xyz); // create copy of xyz
            this.modeldata.attribs.attribs_maps.get(ssid).ps.get(exports.EAttribNames.COORDS).setEntVal(index, new_xyz);
        }
    }
    ...
    class GIAttribsPush {
        ...
        pushAttribVals(source_ent_type, source_attrib_name, source_attrib_idx_key, source_indices, target, target_attrib_name, target_attrib_idx_key, method) {
            ...
            if (target_attrib_idx_key !== null) {
                ...
                if (typeof target_attrib_idx_key === 'number') {
                    target_data_type = exports.EAttribDataTypeStrs.LIST;
                }
                else if (typeof target_attrib_idx_key === 'string') {
                    target_data_type = exports.EAttribDataTypeStrs.DICT;
                }
                else {
                ...
                if (target_data_type === exports.EAttribDataTypeStrs.LIST) {
                ...
                else if (target_data_type === exports.EAttribDataTypeStrs.NUMBER) {
                    target_data_size = 0;
                }
                else {
            ...
            if (target_ent_type === exports.EEntType.MOD) {
            ...
            else if (source_ent_type === exports.EEntType.MOD) {
        ...
        _aggregateVals(values, data_size, method) {
            switch (method) {
                case exports.EAttribPush.AVERAGE:
                    if (data_size > 1) {
                        const result = [];
                        for (let i = 0; i < data_size; i++) {
                            result[i] = mathjs__namespace.mean(values.map(vec => vec[i]));
                        }
                        return result;
                    }
                    else {
                        return mathjs__namespace.mean(values);
                    }
                case exports.EAttribPush.MEDIAN:
                    if (data_size > 1) {
                        const result = [];
                        for (let i = 0; i < data_size; i++) {
                            result[i] = mathjs__namespace.median(values.map(vec => vec[i]));
                        }
                        return result;
                    }
                    else {
                        return mathjs__namespace.median(values);
                    }
                case exports.EAttribPush.SUM:
                    if (data_size > 1) {
                        const result = [];
                        for (let i = 0; i < data_size; i++) {
                            result[i] = mathjs__namespace.sum(values.map(vec => vec[i]));
                        }
                        return result;
                    }
                    else {
                        return mathjs__namespace.sum(values);
                    }
                case exports.EAttribPush.MIN:
                    if (data_size > 1) {
                        const result = [];
                        for (let i = 0; i < data_size; i++) {
                            result[i] = mathjs__namespace.min(values.map(vec => vec[i]));
                        }
                        return result;
                    }
                    else {
                        return mathjs__namespace.min(values);
                    }
                case exports.EAttribPush.MAX:
                    if (data_size > 1) {
                        const result = [];
                        for (let i = 0; i < data_size; i++) {
                            result[i] = mathjs__namespace.max(values.map(vec => vec[i]));
                        }
                        return result;
                    }
                    else {
                        return mathjs__namespace.max(values);
                    }
                case exports.EAttribPush.LAST:
    ...
    const eny_type_array = [
        exports.EEntType.POSI,
        exports.EEntType.VERT,
        exports.EEntType.EDGE,
        exports.EEntType.WIRE,
        exports.EEntType.POINT,
        exports.EEntType.PLINE,
        exports.EEntType.PGON,
        exports.EEntType.COLL,
        exports.EEntType.MOD
    ];
    const ent_type_strs = new Map([
        [exports.EEntType.POSI, 'positions'],
        [exports.EEntType.VERT, 'vertices'],
        [exports.EEntType.EDGE, 'edges'],
        [exports.EEntType.WIRE, 'wires'],
        [exports.EEntType.POINT, 'points'],
        [exports.EEntType.PLINE, 'polylines'],
        [exports.EEntType.PGON, 'polygons'],
        [exports.EEntType.COLL, 'collections'],
        [exports.EEntType.MOD, 'model']
    ]);
    /**
     * Class for attributes.
     */
    ...
    function arrMakeFlat(data) {
        ...
        return lodash__default["default"].flattenDeep(data);
    ...
    class GIFuncsCommon {
        ...
        getCentroid(ents_arr) {
            if (getArrDepth(ents_arr) === 1) {
                ...
                for (const ent_arr of ents_arr) {
                    if (ent_arr[0] === exports.EEntType.POSI) {
            ...
            for (const tri_i of this.modeldata.geom.nav_tri.navPgonToTri(pgon_i)) {
                ...
                for (const posi_i of posis_i) {
                    ...
                    if (posi_v3 === undefined) {
                        ...
                        posi_v3 = new three__namespace.Vector3(xyz[0], xyz[1], xyz[2]);
                    }
                    posis_v3.push(posi_v3);
                }
                const tri_tjs = new three__namespace.Triangle(posis_v3[0], posis_v3[1], posis_v3[2]);
                let midpoint;
        ...
        clonePosisInEntsAndMove(ents_arr, copy_attributes, vector) {
            ...
            for (const ent_arr of ents_arr) {
                ...
                if (ent_type === exports.EEntType.POSI) { // positions
        ...
        clonePosisInEnts(ents_arr, copy_attributes) {
            ...
            for (const ent_arr of ents_arr) {
                ...
                // if you copy a pgon + posi, if you process the pgon first you wil make a copy of the posis
                // but the posi may already be copied by the this.copyGeom function, then we get two copies of that posi
                if (ent_type !== exports.EEntType.POSI) { // obj or coll
    ...
    function _dist(c1, c2, func) {
        if (!Array.isArray(c2[0])) {
            ...
            c2 = c2;
            const tjs_point_proj = new three__namespace.Vector3(c1[0], c1[1], c1[2]);
            const tjs_origin = new three__namespace.Vector3(c2[0][0], c2[0][1], c2[0][2]);
            const p2 = vecAdd(c2[0], c2[1]);
            const tjs_point2 = new three__namespace.Vector3(p2[0], p2[1], p2[2]);
            const tjs_new_point = new three__namespace.Vector3();
            const tjs_line = new three__namespace.Line3(tjs_origin, tjs_point2);
            // project
            ...
            const tjs_normal = new three__namespace.Vector3(normal[0], normal[1], normal[2]);
            const tjs_origin = new three__namespace.Vector3(c2[0][0], c2[0][1], c2[0][2]);
            const tjs_plane = new three__namespace.Plane();
            // project
    ...
    // Enums
    exports._ERingMethod = void 0;
    (function (_ERingMethod) {
        _ERingMethod["OPEN"] = "open";
        _ERingMethod["CLOSE"] = "close";
    })(exports._ERingMethod || (exports._ERingMethod = {}));
    exports._EDivisorMethod = void 0;
    ...
    })(exports._EDivisorMethod || (exports._EDivisorMethod = {}));
    exports._EWeldMethod = void 0;
    (function (_EWeldMethod) {
        _EWeldMethod["MAKE_WELD"] = "make_weld";
        _EWeldMethod["BREAK_WELD"] = "break_weld";
    })(exports._EWeldMethod || (exports._EWeldMethod = {}));
    /**
     * Class for editing geometry.
     */
    class GIFuncsEdit {
        ...
        divide(ents_arr, divisor, method) {
            ...
            if (getArrDepth(ents_arr) === 1) {
                ...
                return all_new_edges_i.map(one_edge_i => [exports.EEntType.EDGE, one_edge_i]);
            }
            else {
        ...
        _divideEdge(edge_i, divisor, method) {
            const posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, edge_i);
            ...
            let new_xyzs;
            if (method === exports._EDivisorMethod.BY_NUMBER) {
                new_xyzs = interpByNum(start, end, divisor - 1);
            }
            else if (method === exports._EDivisorMethod.BY_LENGTH) {
                new_xyzs = interpByLen(start, end, divisor);
            }
            else if (method === exports._EDivisorMethod.BY_MAX_LENGTH) {
        ...
        hole(pgon, holes_ents_arr) {
            ...
            // time stamp
            this.modeldata.getObjsCheckTs(exports.EEntType.PGON, pgon_i);
            // create the hole
            const wires_i = this.modeldata.geom.edit_pgon.cutPgonHoles(pgon_i, holes_posis_i);
            // return hole wires
            return wires_i.map(wire_i => [exports.EEntType.WIRE, wire_i]);
        }
        _getHolePosisFromEnts(ents_arr) {
            ...
            if (depth === 1) {
                ...
                if (ents_arr[0][0] === exports.EEntType.POSI) {
        ...
        weld(ents_arr, method) {
            ...
            // get unique verts
            const map = this.modeldata.geom.query.getEntsMap(ents_arr, [exports.EEntType.VERT, exports.EEntType.POINT, exports.EEntType.PLINE, exports.EEntType.PGON]);
            // time stamp
            map.get(exports.EEntType.POINT).forEach(point_i => this.modeldata.getObjsCheckTs(exports.EEntType.POINT, point_i));
            map.get(exports.EEntType.PLINE).forEach(pline_i => this.modeldata.getObjsCheckTs(exports.EEntType.PLINE, pline_i));
            map.get(exports.EEntType.PGON).forEach(pgon_i => this.modeldata.getObjsCheckTs(exports.EEntType.PGON, pgon_i));
            // process ents
            const verts_i = Array.from(map.get(exports.EEntType.VERT));
            switch (method) {
                case exports._EWeldMethod.BREAK_WELD:
                    this.modeldata.geom.edit_topo.cloneVertPositions(verts_i);
                    break;
                case exports._EWeldMethod.MAKE_WELD:
        ...
        fuse(ents_arr, tolerance) {
            ...
            // ents_arr = this.modeldata.geom.snapshot.copyObjs(ents_arr, false) as TEntTypeIdx[];
            // get unique ents
            const map = this.modeldata.geom.query.getEntsMap(ents_arr, [exports.EEntType.POSI, exports.EEntType.POINT, exports.EEntType.PLINE, exports.EEntType.PGON]);
            // time stamp
            map.get(exports.EEntType.POINT).forEach(point_i => this.modeldata.getObjsCheckTs(exports.EEntType.POINT, point_i));
            map.get(exports.EEntType.PLINE).forEach(pline_i => this.modeldata.getObjsCheckTs(exports.EEntType.PLINE, pline_i));
            map.get(exports.EEntType.PGON).forEach(pgon_i => this.modeldata.getObjsCheckTs(exports.EEntType.PGON, pgon_i));
            // get posis
            const posis_i = Array.from(map.get(exports.EEntType.POSI));
            // find neighbour
            const map_posi_i_to_xyz = new Map();
            const typed_positions = new Float32Array(posis_i.length * 4);
            const typed_buff = new three__namespace.BufferGeometry();
            typed_buff.setAttribute('position', new three__namespace.BufferAttribute(typed_positions, 4));
            ...
            // return new posis
            return new_posis_i.map(posi_i => [exports.EEntType.POSI, posi_i]);
        }
        ...
        ring(ents_arr, method) {
            for (const [ent_type, ent_i] of ents_arr) {
                ...
                //
                switch (method) {
                    case exports._ERingMethod.CLOSE:
                        this.modeldata.geom.edit_pline.closePline(ent_i);
                        break;
                    case exports._ERingMethod.OPEN:
    ...
    function multMatrix(xyz, m) {
        const v2 = new three__namespace.Vector3(...xyz);
        v2.applyMatrix4(m);
        return v2.toArray();
    }
    ...
    function rotateMatrix(ray, angle) {
        ...
        // rotation matrix
        const matrix_rot = new three__namespace.Matrix4();
        matrix_rot.makeRotationAxis(new three__namespace.Vector3(...axis), angle);
        // translation matrix
        const matrix_trn1 = new three__namespace.Matrix4();
        matrix_trn1.makeTranslation(-origin[0], -origin[1], -origin[2]);
        const matrix_trn2 = new three__namespace.Matrix4();
    ...
    function scaleMatrix(plane, factor) {
        // scale matrix
        const matrix_scale = new three__namespace.Matrix4();
    ...
    function xformMatrix(plane, neg) {
        const o = new three__namespace.Vector3(...plane[0]);
        const x = new three__namespace.Vector3(...plane[1]);
        const y = new three__namespace.Vector3(...plane[2]);
        const z = new three__namespace.Vector3(...vecCross(plane[1], plane[2]));
        if (neg) {
            o.negate();
        }
        // origin translate matrix
        const m1 = new three__namespace.Matrix4();
        m1.setPosition(o);
        // xfrom matrix
        const m2 = new three__namespace.Matrix4();
        m2.makeBasis(x, y, z);
        // combine two matrices
        const m3 = new three__namespace.Matrix4();
        if (neg) {
            const m2x = (new three__namespace.Matrix4()).copy(m2).invert();
    ...
    // Enums
    exports._EClose = void 0;
    (function (_EClose) {
        _EClose["OPEN"] = "open";
        _EClose["CLOSE"] = "close";
    })(exports._EClose || (exports._EClose = {}));
    exports._ELoftMethod = void 0;
    ...
    })(exports._ELoftMethod || (exports._ELoftMethod = {}));
    exports._EExtrudeMethod = void 0;
    ...
    class GIFuncsMake {
        ...
        position(coords) {
            ...
            if (depth === 1) {
                const coord1 = coords;
                const posi_i = this.modeldata.geom.add.addPosi();
                this.modeldata.attribs.set.setEntAttribVal(exports.EEntType.POSI, posi_i, exports.EAttribNames.COORDS, coord1);
                return [exports.EEntType.POSI, posi_i];
            }
            else if (depth === 2) {
        ...
        point(ents_arr) {
            ...
            if (depth === 1) {
                ...
                if (ent_type === exports.EEntType.POSI) {
                    ...
                    return [exports.EEntType.POINT, point_i];
                }
                else {
                    const posis_i = this.modeldata.geom.nav.navAnyToPosi(ent_type, index);
                    return posis_i.map(posi_i => this.point([exports.EEntType.POSI, posi_i]));
                }
            }
            else if (depth === 2) {
                ents_arr = ents_arr;
        ...
        _getPlinePosisFromEnts(ents_arr) {
            ...
            if (getArrDepth(ents_arr) === 2 && isDim0(ents_arr[0][0])) {
                ...
                for (const ent_arr of ents_arr) {
                    ...
                    if (ent_type === exports.EEntType.POSI) {
                        ...
                        const posis_i = this.modeldata.geom.nav.navAnyToPosi(ent_type, index);
                        for (const posi_i of posis_i) {
                            ents_arr2.push([exports.EEntType.POSI, posi_i]);
                        }
                    }
                }
                ents_arr = [ents_arr2];
            ...
            for (const ent_arr of ents_arr) {
                ...
                switch (ent_type) {
                    ...
                    case exports.EEntType.PLINE:
                        const posis_i = this.modeldata.geom.nav.navAnyToPosi(ent_type, index);
                        const posis_arr = posis_i.map(posi_i => [exports.EEntType.POSI, posi_i]);
                    ...
                    case exports.EEntType.PGON:
                        ...
                        for (let j = 0; j < wires_i.length; j++) {
                            ...
                            const wire_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, wire_i);
                            const wire_posis_arr = wire_posis_i.map(posi_i => [exports.EEntType.POSI, posi_i]);
        ...
        _polygon(posis_arr) {
            ...
            if (depth === 2) {
                ...
                return [exports.EEntType.PGON, pgon_i];
            }
            else {
                posis_arr = posis_arr;
        ...
        _getPgonPosisFromEnts(ents_arr) {
            ...
            if (getArrDepth(ents_arr) === 2 && ents_arr[0][0] === exports.EEntType.POSI) {
        ...
        loft(ents_arrs, divisions, method) {
            ...
            if (depth === 2) {
                ...
                switch (method) {
                    case exports._ELoftMethod.OPEN_QUADS:
                    case exports._ELoftMethod.CLOSED_QUADS:
                        return this._loftQuads(ents_arr, divisions, method);
                    case exports._ELoftMethod.OPEN_STRINGERS:
                    case exports._ELoftMethod.CLOSED_STRINGERS:
                        return this._loftStringers(ents_arr, divisions, method);
                    case exports._ELoftMethod.OPEN_RIBS:
                    case exports._ELoftMethod.CLOSED_RIBS:
                        return this._loftRibs(ents_arr, divisions, method);
                    case exports._ELoftMethod.COPIES:
        ...
        _loftQuads(ents_arr, divisions, method) {
            ...
            if (method === exports._ELoftMethod.CLOSED_QUADS) {
            ...
            for (let i = 0; i < edges_arrs_i.length - 1; i++) {
                ...
                if (divisions > 0) {
                    ...
                    for (let j = 0; j < num_edges; j++) {
                        ...
                        const exist_posis_a_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, edge_i_a);
                        const exist_posis_b_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, edge_i_b);
                    ...
                    for (let j = 0; j < num_edges; j++) {
                        const posis_i_a = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, edges_i_a[j]);
                        const posis_i_b = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, edges_i_b[j]);
                        const pgon_i = this.modeldata.geom.add.addPgon([posis_i_a[0], posis_i_a[1], posis_i_b[1], posis_i_b[0]]);
                        new_pgons_i.push(pgon_i);
                    }
                }
            }
            return new_pgons_i.map(pgon_i => [exports.EEntType.PGON, pgon_i]);
        }
        _loftStringers(ents_arr, divisions, method) {
            ...
            const is_closed = method === exports._ELoftMethod.CLOSED_STRINGERS;
            if (is_closed) {
            ...
            return stringer_plines_i.map(pline_i => [exports.EEntType.PLINE, pline_i]);
        }
        _loftRibs(ents_arr, divisions, method) {
            ...
            const is_closed = method === exports._ELoftMethod.CLOSED_RIBS;
            if (is_closed) {
                posis_arrs_i.push(posis_arrs_i[0]);
            }
            ...
            return rib_plines_i.map(pline_i => [exports.EEntType.PLINE, pline_i]);
        }
        ...
        extrude(ents_arr, dist, divisions, method) {
            // extrude
            if (method === exports._EExtrudeMethod.COPIES) {
        ...
        _extrudeColl(index, extrude_vec, divisions, method) {
            ...
            const res1 = points_i.map(point_i => this._extrudeEdges([exports.EEntType.POINT, point_i], extrude_vec, divisions, method));
            const plines_i = this.modeldata.geom.nav.navCollToPline(index);
            const res2 = plines_i.map(pline_i => this._extrudeEdges([exports.EEntType.PLINE, pline_i], extrude_vec, divisions, method));
            const pgons_i = this.modeldata.geom.nav.navCollToPgon(index);
            const res3 = pgons_i.map(pgon_i => this._extrudeEdges([exports.EEntType.PGON, pgon_i], extrude_vec, divisions, method));
        ...
        _extrudeQuads(ent_type, index, extrude_vec, divisions) {
            ...
            for (const edge_i of edges_i) {
                // get exist posis_i
                const exist_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, edge_i);
                // create the new posis strip if necessary
        ...
        _extrudeStringers(ent_type, index, extrude_vec, divisions) {
            ...
            return new_plines_i.map(pline_i => [exports.EEntType.PLINE, pline_i]);
        }
            ...
            switch (ent_type) { // check if the entity is closed
                case exports.EEntType.PGON:
                    ...
                    for (const face_wire_i of face_wires_i) {
                        const face_wire_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, face_wire_i);
                        ribs_posis_i.push(face_wire_posis_i);
                    }
                    break;
                case exports.EEntType.PLINE:
                    const pline_wire_i = this.modeldata.geom.nav.navPlineToWire(index);
                    const pline_wire_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, pline_wire_i);
                    ribs_posis_i.push(pline_wire_posis_i);
                    ribs_is_closed = this.modeldata.geom.query.isWireClosed(pline_wire_i);
                    break;
                case exports.EEntType.WIRE:
                    const wire_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, index);
        ...
        _extrudeCap(pgon_i, strip_posis_map, divisions) {
            ...
            const old_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, old_wire_i);
            ...
            for (const old_hole_wire_i of old_holes_wires_i) {
                const old_hole_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, old_hole_wire_i);
        ...
        sweep(backbone_ents, xsection_ent, divisions, method) {
            ...
            if (xsection_ent_type === exports.EEntType.WIRE) {
        ...
        _sweep(backbone_wires_i, xsection_wire_i, divisions, method) {
            if (!Array.isArray(backbone_wires_i)) {
                ...
                switch (method) {
                    ...
                    case exports._EExtrudeMethod.COPIES:
        ...
        _sweepQuads(backbone_wire_i, xsection_wire_i, divisions) {
            ...
            for (let i = 0; i < strips_posis_i.length - 1; i++) {
                ...
                for (let j = 0; j < strip1_posis_i.length - 1; j++) {
                    ...
                    const pgon_i = this.modeldata.geom.add.addPgon([c1, c2, c3, c4]);
                    new_pgons.push([exports.EEntType.PGON, pgon_i]);
                }
            }
            return new_pgons;
        }
        _listZip(debug, list1, list2) {
            if (arguments.length === 2) {
                return lodash__default["default"].unzip(list1);
            }
            const lists = Array.from(arguments).slice(1);
            return lodash__default["default"].zip(...lists);
        }
        _sweepStringers(backbone_wire_i, xsection_wire_i, divisions) {
            ...
            for (const stringer_posis_i of stringers_posis_i) {
                ...
                plines.push([exports.EEntType.PLINE, pline_i]);
            }
            return plines;
        }
        ...
        _sweepPosis(backbone_wire_i, xsection_wire_i, divisions) {
            ...
            const xsextion_xyzs = this.modeldata.attribs.posis.getEntCoords(exports.EEntType.WIRE, xsection_wire_i);
            ...
            const wire_xyzs = this.modeldata.attribs.posis.getEntCoords(exports.EEntType.WIRE, backbone_wire_i);
            let plane_xyzs = [];
        ...
        join(ents_arr) {
            ...
            for (const [ent_type, ent_i] of ents_arr) {
                ...
                else if (ent_type === exports.EEntType.PGON) {
                    set_pgons.add(ent_i);
                }
                else {
            ...
            return this._joinPgons(Array.from(set_pgons)).map(pgon_i => [exports.EEntType.PGON, pgon_i]);
        }
        ...
        _joinPlines(plines_i) {
            for (const pline_i of plines_i) {
                const edges_i = this.modeldata.geom.nav.navAnyToEdge(exports.EEntType.PLINE, pline_i);
                for (const edge_i of edges_i) {
                }
            }
            //
        ...
        _joinPgons(pgons_i) {
            ...
            for (const grp_set of Array.from(grp_pgons_map.values())) {
                ...
                const edge_attribs = this.modeldata.attribs.getAttribNames(exports.EEntType.EDGE).map(name => this.modeldata.attribs.getAttrib(exports.EEntType.EDGE, name));
                ...
                for (const loop_edges_i of loops_edges_i) {
                    ...
                    if (edge_attribs.length) {
                        const new_edges_i = this.modeldata.geom.nav.navAnyToEdge(exports.EEntType.PGON, new_pgon_i);
        ...
        cut(ents_arr, plane, method) {
            ...
            const plane_tjs = new three__namespace.Plane();
            plane_tjs.setFromNormalAndCoplanarPoint(new three__namespace.Vector3(...plane_normal), new three__namespace.Vector3(...plane[0]));
            // get polylines and polygons
            const set_plines = new Set();
            const set_pgons = new Set();
            ...
            for (const exist_pline_i of Array.from(set_plines)) {
                const sliced = this._cutCreateEnts(exports.EEntType.PLINE, exist_pline_i, edge_to_isect_posis, posi_to_copies, cut_posi_to_copies, posi_to_tjs, method);
                for (const new_pline_i of sliced[0]) {
                    above.push([exports.EEntType.PLINE, new_pline_i]);
                }
                for (const new_pline_i of sliced[1]) {
                    below.push([exports.EEntType.PLINE, new_pline_i]);
                }
            }
            // slice polygons
            for (const exist_pgon_i of Array.from(set_pgons)) {
                // TODO slice polygons with holes
                const sliced = this._cutCreateEnts(exports.EEntType.PGON, exist_pgon_i, edge_to_isect_posis, posi_to_copies, cut_posi_to_copies, posi_to_tjs, method);
                for (const new_pgon_i of sliced[0]) {
                    above.push([exports.EEntType.PGON, new_pgon_i]);
                }
                for (const new_pgon_i of sliced[1]) {
                    below.push([exports.EEntType.PGON, new_pgon_i]);
                }
            }
            // return
            return [above, below];
        ...
        _cutEdges(edges_i, plane_tjs, method) {
            ...
            for (const edge_i of edges_i) {
                ...
                const edge_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, edge_i);
                ...
                if (posi_i === undefined) {
                    ...
                    if (new_posi_i !== null) {
                        ...
                        if (method === exports._ECutMethod.KEEP_BOTH) {
        ...
        _cutCreatePosi(edge_i, edge_posis_i, plane_tjs, smap_posi_to_tjs) {
            ...
            const line_tjs = new three__namespace.Line3(posi0_tjs, posi1_tjs);
            const isect_tjs = new three__namespace.Vector3();
        ...
        _cutStartVertexIsV(edge_i, plane_tjs, d1, smap_posi_to_tjs) {
            ...
            // check other edge
            const prev_edge_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, prev_edge_i);
        ...
        _cutEndVertexIsV(edge_i, plane_tjs, d0, smap_posi_to_tjs) {
            ...
            // check other edge
            const next_edge_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, next_edge_i);
        ...
        _cutGetTjsDistToPlane(posi_i, plane_tjs, map_posi_to_tjs) {
            ...
            // create tjs posi
            const xyz = this.modeldata.attribs.posis.getPosiCoords(posi_i);
            const posi_tjs = new three__namespace.Vector3(...xyz);
        ...
        _cutCreateEnts(ent_type, ent_i, edge_to_isect_posis, posi_to_copies, cut_posi_to_copies, posi_to_tjs, method) {
            ...
            for (let i = 0; i < num_posis - 1; i++) {
                ...
                if (isect_posi_i !== null) {
                    num_cuts += 1;
                    // add posi before cut
                    if (method === exports._ECutMethod.KEEP_BOTH && index === 0) {
            ...
            if (ent_type === exports.EEntType.PGON && num_cuts % 2 !== 0) {
            ...
            if (slice_posis_i[second].length === 0) {
                if (start_above && (method === exports._ECutMethod.KEEP_BOTH || method === exports._ECutMethod.KEEP_ABOVE)) {
                    return [[this._cutCopyEnt(ent_type, ent_i, wire_posis_i, posi_to_copies)], []];
                }
                else if (!start_above && (method === exports._ECutMethod.KEEP_BOTH || method === exports._ECutMethod.KEEP_BELOW)) {
                    return [[], [this._cutCopyEnt(ent_type, ent_i, wire_posis_i, posi_to_copies)]];
                }
                return [[], []];
            }
            ...
            const below = [];
            switch (method) {
                case exports._ECutMethod.KEEP_BOTH:
                case exports._ECutMethod.KEEP_ABOVE:
            ...
            switch (method) {
                case exports._ECutMethod.KEEP_BOTH:
                case exports._ECutMethod.KEEP_BELOW:
    ...
    class GIFuncsModify {
        ...
        _offsetWire(wire_i, dist) {
            ...
            const edges_i = this.modeldata.geom.nav.navAnyToEdge(exports.EEntType.WIRE, wire_i).slice(); // make a copy
            const is_closed = this.modeldata.geom.query.isWireClosed(wire_i);
    ...
    function subVectors(v1, v2, norm = false) {
        const v3 = new three__namespace.Vector3();
        v3.subVectors(v1, v2);
        if (norm) {
            v3.normalize();
        }
    ...
    function normal(v1, v2, v3, norm = false) {
        const _v1 = new three__namespace.Vector3(...v1);
        const _v2 = new three__namespace.Vector3(...v2);
        const _v3 = new three__namespace.Vector3(...v3);
        const t = new three__namespace.Triangle(_v1, _v2, _v3);
    ...
    function _getThreePoints(points) {
        ...
        if (three_selected.length === 3) {
            ...
            const line = new three__namespace.Line3(points[first], points[second]);
            let third;
            let dist = 0;
            for (let i = 0; i < points.length; i++) {
                const cur_point = points[i];
                if (cur_point !== points[first] && cur_point !== points[second]) {
                    const dummy = new three__namespace.Vector3();
    ...
    function triangulate(coords, holes) {
        ...
        const coords_v = coords.map(coord => new three__namespace.Vector3(...coord));
        ...
        if (has_holes) {
            for (const hole of holes) {
                ...
                if (hole.length) {
                    const hole_coords_v = hole.map(hole_coord => new three__namespace.Vector3(...hole_coord));
    ...
    class GIGeomAdd {
        ...
        addPosi() {
            ...
            // snapshot
            this.modeldata.geom.snapshot.addNewEnt(ssid, exports.EEntType.POSI, posi_i);
        ...
        addPoint(posi_i) {
            ...
            // time stamp
            this.modeldata.attribs.set.setEntAttribVal(exports.EEntType.POINT, point_i, exports.EAttribNames.TIMESTAMP, this.modeldata.active_ssid);
            // snapshot
            this.modeldata.geom.snapshot.addNewEnt(ssid, exports.EEntType.POINT, point_i);
            // return entity number
            return point_i;
        }
        /**
        ...
        addPline(posis_i, close = false) {
            ...
            // time stamp
            this.modeldata.attribs.set.setEntAttribVal(exports.EEntType.PLINE, pline_i, exports.EAttribNames.TIMESTAMP, this.modeldata.active_ssid);
            // snapshot
            this.modeldata.geom.snapshot.addNewEnt(ssid, exports.EEntType.PLINE, pline_i);
            // return entity number
            return pline_i;
        }
        /**
        ...
        addPgon(posis_i, holes_posis_i) {
            ...
            // time stamp
            this.modeldata.attribs.set.setEntAttribVal(exports.EEntType.PGON, pgon_i, exports.EAttribNames.TIMESTAMP, this.modeldata.active_ssid);
            // snapshot
            this.modeldata.geom.snapshot.addNewEnt(ssid, exports.EEntType.PGON, pgon_i);
            // return entity number
            return pgon_i;
        }
        /**
        ...
        addColl() {
            ...
            // snapshot
            this.modeldata.geom.snapshot.addNewEnt(ssid, exports.EEntType.COLL, coll_i);
            // return entity number
            return coll_i;
        }
        // ============================================================================
        ...
        copyMovePosi(posi_i, move_vector, copy_attribs) {
            ...
            if (copy_attribs) {
                const attrib_names = this.modeldata.attribs.getAttribNames(exports.EEntType.POSI);
                for (const attrib_name of attrib_names) {
                    if (attrib_name !== 'xyz') {
                        const value = this.modeldata.attribs.get.getEntAttribVal(exports.EEntType.POSI, posi_i, attrib_name);
                        this.modeldata.attribs.set.setEntAttribVal(exports.EEntType.POSI, new_posi_i, attrib_name, value);
                    }
                }
            }
            return new_posi_i;
        ...
        copyPoint(old_point_i, copy_attribs) {
            const posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.POINT, old_point_i);
            const new_point_i = this.addPoint(posis_i[0]);
            if (copy_attribs) {
                this.modeldata.attribs.set.copyAttribs(exports.EEntType.POINT, old_point_i, new_point_i);
                ...
                this.modeldata.attribs.set.copyAttribs(exports.EEntType.VERT, old_vert_i, new_vert_i);
            }
        ...
        copyPline(old_pline_i, copy_attribs) {
            const posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.PLINE, old_pline_i);
            const wire_i = this.modeldata.geom.nav.navPlineToWire(old_pline_i);
            const is_closed = this.modeldata.geom.query.isWireClosed(wire_i);
            const new_pline_i = this.addPline(posis_i, is_closed);
            if (copy_attribs) {
                this.modeldata.attribs.set.copyAttribs(exports.EEntType.PLINE, old_pline_i, new_pline_i);
                const old_topo = this.modeldata.geom.query.getObjTopo(exports.EEntType.PLINE, old_pline_i);
                const new_topo = this.modeldata.geom.query.getObjTopo(exports.EEntType.PLINE, new_pline_i);
                for (let i = 0; i < old_topo[0].length; i++) {
                    this.modeldata.attribs.set.copyAttribs(exports.EEntType.VERT, old_topo[0][i], new_topo[0][i]);
                }
                for (let i = 0; i < old_topo[1].length; i++) {
                    this.modeldata.attribs.set.copyAttribs(exports.EEntType.EDGE, old_topo[1][i], new_topo[1][i]);
                }
                for (let i = 0; i < old_topo[2].length; i++) {
                    this.modeldata.attribs.set.copyAttribs(exports.EEntType.WIRE, old_topo[2][i], new_topo[2][i]);
                }
            }
        ...
        copyPgon(old_pgon_i, copy_attribs) {
            const wires_i = this.modeldata.geom.nav.navAnyToWire(exports.EEntType.PGON, old_pgon_i);
            const posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, wires_i[0]);
            let new_pgon_i;
            if (wires_i.length === 1) {
                ...
                for (let i = 1; i < wires_i.length; i++) {
                    const hole_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, wires_i[i]);
                    holes_posis_i.push(hole_posis_i);
                }
                new_pgon_i = this.addPgon(posis_i, holes_posis_i);
            }
            if (copy_attribs) {
                this.modeldata.attribs.set.copyAttribs(exports.EEntType.PGON, old_pgon_i, new_pgon_i);
                const old_topo = this.modeldata.geom.query.getObjTopo(exports.EEntType.PGON, old_pgon_i);
                const new_topo = this.modeldata.geom.query.getObjTopo(exports.EEntType.PGON, new_pgon_i);
                for (let i = 0; i < old_topo[0].length; i++) {
                    this.modeldata.attribs.set.copyAttribs(exports.EEntType.VERT, old_topo[0][i], new_topo[0][i]);
                }
                for (let i = 0; i < old_topo[1].length; i++) {
        ...
        copyColl(old_coll_i, copy_attribs) {
            ...
            if (copy_attribs) {
                this.modeldata.attribs.set.copyAttribs(exports.EEntType.COLL, old_coll_i, new_coll_i);
            }
        ...
        _addTris(wire_i, hole_wires_i) {
            ...
            const wire_verts_i = this.modeldata.geom.nav.navAnyToVert(exports.EEntType.WIRE, wire_i);
            ...
            if (hole_wires_i !== undefined) {
                for (const hole_wire_i of hole_wires_i) {
                    const hole_wire_verts_i = this.modeldata.geom.nav.navAnyToVert(exports.EEntType.WIRE, hole_wire_i);
            ...
            if (edges_i !== undefined) {
                ...
                switch (num_edges) {
                    case 1:
                        ...
                        const edge_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, edges_i[0]);
                    ...
                    case 2:
                        ...
                        const [a_posi_i, b1_posi_i] = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, prev_edge_i);
                        const [b2_posi_i, c_posi_i] = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, next_edge_i);
    ...
    class GIGeomQuery {
         ...
         */
        getEnts(ent_type) {
            const geom_map_key = exports.EEntStrToGeomMaps[ent_type];
            // collections
            if (ent_type === exports.EEntType.COLL) {
         ...
         */
        numEnts(ent_type) {
            const geom_array_key = exports.EEntStrToGeomMaps[ent_type];
        ...
        numEntsAll() {
            return [
                this.numEnts(exports.EEntType.POSI),
                this.numEnts(exports.EEntType.POINT),
                this.numEnts(exports.EEntType.PLINE),
                this.numEnts(exports.EEntType.PGON),
                this.numEnts(exports.EEntType.COLL)
            ];
        }
        /**
        ...
        entExists(ent_type, index) {
            const geom_maps_key = exports.EEntStrToGeomMaps[ent_type];
        ...
        getEntsMap(ents, ent_types) {
            ...
            for (const [ent_type, ent_i] of ents) {
                if (set_ent_types.has(exports.EEntType.COLL)) {
                    this.modeldata.geom.nav.navAnyToColl(ent_type, ent_i).forEach(coll_i => map.get(exports.EEntType.COLL).add(coll_i));
                }
                if (set_ent_types.has(exports.EEntType.PGON)) {
                    this.modeldata.geom.nav.navAnyToPgon(ent_type, ent_i).forEach(pgon_i => map.get(exports.EEntType.PGON).add(pgon_i));
                }
                if (set_ent_types.has(exports.EEntType.PLINE)) {
                    this.modeldata.geom.nav.navAnyToPline(ent_type, ent_i).forEach(pline_i => map.get(exports.EEntType.PLINE).add(pline_i));
                }
                if (set_ent_types.has(exports.EEntType.POINT)) {
                    this.modeldata.geom.nav.navAnyToPoint(ent_type, ent_i).forEach(point_i => map.get(exports.EEntType.POINT).add(point_i));
                }
                if (set_ent_types.has(exports.EEntType.WIRE)) {
                    this.modeldata.geom.nav.navAnyToWire(ent_type, ent_i).forEach(wire_i => map.get(exports.EEntType.WIRE).add(wire_i));
                }
                if (set_ent_types.has(exports.EEntType.EDGE)) {
                    this.modeldata.geom.nav.navAnyToEdge(ent_type, ent_i).forEach(edge_i => map.get(exports.EEntType.EDGE).add(edge_i));
                }
                if (set_ent_types.has(exports.EEntType.VERT)) {
                    this.modeldata.geom.nav.navAnyToVert(ent_type, ent_i).forEach(vert_i => map.get(exports.EEntType.VERT).add(vert_i));
                }
                if (set_ent_types.has(exports.EEntType.POSI)) {
                    this.modeldata.geom.nav.navAnyToPosi(ent_type, ent_i).forEach(posi_i => map.get(exports.EEntType.POSI).add(posi_i));
                }
            }
            return map;
        }
        ...
        getNeighborEdges(edge_i) {
            ...
            const start_edges_i = this.modeldata.geom.nav.navAnyToEdge(exports.EEntType.POSI, start_posi_i);
            const end_edges_i = this.modeldata.geom.nav.navAnyToEdge(exports.EEntType.POSI, end_posi_i);
            return mathjs__namespace.setIntersect(start_edges_i, end_edges_i);
        }
        // ============================================================================
        // Wires
        // ============================================================================
        ...
        getWireType(wire_i) {
            ...
            if (this.modeldata.geom.nav.navWireToPline(wire_i) !== undefined) {
                return exports.EWireType.PLINE;
            }
            ...
            if (index === 0) {
                return exports.EWireType.PGON;
            }
            if (index > 0) {
                return exports.EWireType.PGON_HOLE;
            }
        ...
        getWireNormal(wire_i) {
            ...
            const centroid = this.getCentroid(exports.EEntType.WIRE, wire_i);
            const normal = [0, 0, 0];
            // let count = 0;
            for (const edge_i of edges_i) {
            ...
            for (const vert_i of verts_i) {
                ...
                for (const found_vert_i of found_verts_i) {
                    if (verts_i.indexOf(found_vert_i) === -1) {
                        const found_ents_i = this.modeldata.geom.nav.navAnyToAny(exports.EEntType.VERT, ent_type, found_vert_i);
        ...
        perimeter(ent_type, edges_i) {
            ...
            for (const edge_i of edges_i) {
                const posi_pair_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, edge_i);
            ...
            for (const edge_i of edges_i) {
                ...
                if (!edge_posis_map.has(posi_pair_i[1]) || edge_posis_map.get(posi_pair_i[1]).indexOf(posi_pair_i[0]) === -1) {
                    const found_ents_i = this.modeldata.geom.nav.navAnyToAny(exports.EEntType.EDGE, ent_type, edge_i);
        ...
        getEntSubEnts(ent_type, ent_i) {
            ...
            switch (ent_type) {
                case exports.EEntType.COLL:
                    {
                        for (const coll_i of this.modeldata.geom.nav.navCollToCollChildren(ent_i)) {
                            tree.push([exports.EEntType.COLL, coll_i]);
                        }
                    }
                    return tree;
                case exports.EEntType.PGON:
                ...
                case exports.EEntType.POINT:
                    {
                        const vert_i = this.modeldata.geom.nav.navPointToVert(ent_i);
                        tree.push([exports.EEntType.VERT, vert_i]);
                        tree.push([exports.EEntType.POSI, this.modeldata.geom.nav.navVertToPosi(vert_i)]);
                    }
                    return tree;
            }
        }
        _addtWireSubEnts(wire_i, tree) {
            tree.push([exports.EEntType.WIRE, wire_i]);
            const edges_i = this.modeldata.geom.nav.navWireToEdge(wire_i);
            for (const edge_i of edges_i) {
                const [vert0_i, vert1_i] = this.modeldata.geom.nav.navEdgeToVert(edge_i);
                const posi0_i = this.modeldata.geom.nav.navVertToPosi(vert0_i);
                tree.push([exports.EEntType.VERT, vert0_i]);
                tree.push([exports.EEntType.POSI, posi0_i]);
                tree.push([exports.EEntType.EDGE, edge_i]);
                if (edge_i === edges_i[edges_i.length - 1]) {
                    const posi1_i = this.modeldata.geom.nav.navVertToPosi(vert1_i);
                    tree.push([exports.EEntType.VERT, vert1_i]);
                    tree.push([exports.EEntType.POSI, posi1_i]);
                }
            }
        }
    }
    ...
    class GIGeomEditPgon {
        ...
        triPgons(pgons_i) {
            if (!Array.isArray(pgons_i)) {
                ...
                const wires_i = this.modeldata.geom.nav.navAnyToWire(exports.EEntType.PGON, pgon_i);
    ...
    class GIGeomNav {
        ...
        navPosiToVert(posi_i) {
            const ssid = this.modeldata.active_ssid;
            return this._geom_maps.up_posis_verts.get(posi_i).filter(ent_i => this.modeldata.geom.snapshot.hasEnt(ssid, exports.EEntType.VERT, ent_i));
        }
        /**
        ...
        navAnyToAny(from_ets, to_ets, ent_i) {
            ...
            if (from_ets === exports.EEntType.COLL && to_ets === exports.EEntType.COLL) {
    ...
    class GIGeomDelVert {
        ...
        delVert(vert_i) {
            ...
            if (this.modeldata.geom._geom_maps.up_verts_tris.has(vert_i)) {
                const pgon_i = this.modeldata.geom.nav.navAnyToPgon(exports.EEntType.VERT, vert_i)[0];
            ...
            // pline
            const pline_i = this.modeldata.geom.nav.navAnyToPline(exports.EEntType.VERT, vert_i)[0];
        ...
        delPlineVerts(pline_i, verts_i) {
            ...
            if (num_verts - verts_i.length < 2) {
                const pline_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, wire_i);
            ...
            this.modeldata.getObjsCheckTs(exports.EEntType.PLINE, pline_i);
            // delete the verts
            for (const vert_i of verts_i) {
        ...
        delPgonVerts(pgon_i, verts_i) {
            ...
            const wires_i = this._geom_maps.dn_pgons_wires.get(pgon_i);
            const num_verts = this.modeldata.geom.nav.navAnyToVert(exports.EEntType.PGON, pgon_i).length;
            // do we have to delete the whole pgon?
            if (num_verts - verts_i.length < 3) {
                const pgon_posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.PGON, pgon_i);
            ...
            // delete the verts
            for (const vert_i of verts_i) {
                const wire_i = this.modeldata.geom.nav.navAnyToWire(exports.EEntType.VERT, vert_i)[0];
                const wire_edges_i = this._geom_maps.dn_wires_edges.get(wire_i);
                // update the edges and wires
                if (num_verts === 3) {
        ...
        __delVert__OpenPlineStart(wire_edges_i, wire_verts_i, vert_i) {
            ...
            this.modeldata.attribs.del.delEnt(exports.EEntType.EDGE, start_edge_i);
            ...
            this.modeldata.attribs.del.delEnt(exports.EEntType.VERT, vert_i);
            // update the posis
        ...
        __delVert__OpenPlineEnd(wire_edges_i, wire_verts_i, vert_i) {
            ...
            this.modeldata.attribs.del.delEnt(exports.EEntType.EDGE, end_edge_i);
        ...
        __delVert__StandardCase(wire_edges_i, vert_i) {
            ...
            this.modeldata.attribs.del.delEnt(exports.EEntType.EDGE, next_edge_i);
            // update the wire
    ...
    class GIGeomSnapshot {
        ...
        copyEntsToActiveSnapshot(from_ssid, ents) {
            ...
            for (const [ent_type, ent_i] of ents) {
                if (ent_type === exports.EEntType.POSI || ent_type >= exports.EEntType.POINT) {
                    to_data[exports.EEntTypeStr[ent_type]].add(ent_i);
                    // handle collections
                    if (ent_type === exports.EEntType.COLL) {
        ...
        hasEnt(ssid, ent_type, ent_i) {
            switch (ent_type) {
                ...
                case exports.EEntType.PGON:
                case exports.EEntType.COLL:
                    const ent_set = this.ss_data.get(ssid)[exports.EEntTypeStr[ent_type]];
        ...
        getAllEnts(ssid) {
            const ents = [];
            this.ss_data.get(ssid).ps.forEach(posi_i => ents.push([exports.EEntType.POSI, posi_i]));
            this.ss_data.get(ssid).pt.forEach(point_i => ents.push([exports.EEntType.POINT, point_i]));
            this.ss_data.get(ssid).pl.forEach(pline_i => ents.push([exports.EEntType.PLINE, pline_i]));
            this.ss_data.get(ssid).pg.forEach(pgon_i => ents.push([exports.EEntType.PGON, pgon_i]));
            this.ss_data.get(ssid).co.forEach(coll_i => ents.push([exports.EEntType.COLL, coll_i]));
            return ents;
        }
        /**
                ...
                default:
                    if (ent_type === exports.EEntType.VERT) {
                        ...
                        for (const pline_i of this.ss_data.get(ssid).pl) {
                            for (const vert_i of this.modeldata.geom.nav.navAnyToVert(exports.EEntType.PLINE, pline_i)) {
                                verts_i.push(vert_i);
                            }
                        }
                    ...
                    else if (ent_type === exports.EEntType.EDGE) {
                        const edges_i = [];
                        for (const pline_i of this.ss_data.get(ssid).pl) {
                            for (const edge_i of this.modeldata.geom.nav.navAnyToEdge(exports.EEntType.PLINE, pline_i)) {
                                edges_i.push(edge_i);
                            }
                        }
                        for (const pgon_i of this.ss_data.get(ssid).pg) {
                            for (const edge_i of this.modeldata.geom.nav.navAnyToEdge(exports.EEntType.PGON, pgon_i)) {
                                edges_i.push(edge_i);
                            }
                        }
                        return edges_i;
                    }
                    else if (ent_type === exports.EEntType.WIRE) {
                        const wires_i = [];
                        for (const pline_i of this.ss_data.get(ssid).pl) {
                            wires_i.push(this.modeldata.geom.nav.navPlineToWire(pline_i));
                        }
                        for (const pgon_i of this.ss_data.get(ssid).pg) {
                            for (const wire_i of this.modeldata.geom.nav.navAnyToWire(exports.EEntType.PGON, pgon_i)) {
                                wires_i.push(wire_i);
                            }
                        }
                        return wires_i;
                    }
                    else if (ent_type === exports.EEntType.TRI) {
                        const tris_i = [];
                        for (const pgon_i of this.ss_data.get(ssid).pg) {
                            for (const tri_i of this.modeldata.geom.nav_tri.navPgonToTri(pgon_i)) {
                                tris_i.push(tri_i);
        ...
        getSubEnts(ents_sets) {
            const ents_arr = [];
            ents_sets.ps.forEach(posi_i => ents_arr.push([exports.EEntType.POSI, posi_i]));
            ents_sets.obj_ps.forEach(posi_i => ents_arr.push([exports.EEntType.POSI, posi_i]));
            ents_sets.pt.forEach(point_i => ents_arr.push([exports.EEntType.POINT, point_i]));
            ents_sets.pl.forEach(pline_i => ents_arr.push([exports.EEntType.PLINE, pline_i]));
            ents_sets.pg.forEach(pgon_i => ents_arr.push([exports.EEntType.PGON, pgon_i]));
            ents_sets.co.forEach(coll_i => ents_arr.push([exports.EEntType.COLL, coll_i]));
            if (ents_sets.hasOwnProperty('_v')) {
                ents_sets._v.forEach(vert_i => ents_arr.push([exports.EEntType.VERT, vert_i]));
            }
            if (ents_sets.hasOwnProperty('_e')) {
                ents_sets._e.forEach(vert_i => ents_arr.push([exports.EEntType.EDGE, vert_i]));
            }
            if (ents_sets.hasOwnProperty('_w')) {
                ents_sets._w.forEach(vert_i => ents_arr.push([exports.EEntType.WIRE, vert_i]));
            }
            return ents_arr;
        }
        /**
        ...
        getSubEntsSets(ssid, ents) {
            ...
            for (const ent_arr of ents) {
                ...
                else if (ent_type === exports.EEntType.PLINE) {
                    ent_sets.pl.add(ent_i);
                }
                else if (ent_type === exports.EEntType.POINT) {
                    ent_sets.pt.add(ent_i);
                }
                else if (ent_type === exports.EEntType.POSI) {
                    ent_sets.ps.add(ent_i);
                }
            }
            // now get all the posis of the objs and add them to the list
            ent_sets.pt.forEach(point_i => {
                const posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.POINT, point_i);
                posis_i.forEach(posi_i => {
                    ent_sets.obj_ps.add(posi_i);
                });
            });
            ent_sets.pl.forEach(pline_i => {
                const posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.PLINE, pline_i);
                posis_i.forEach(posi_i => {
                    ent_sets.obj_ps.add(posi_i);
                });
            });
            ent_sets.pg.forEach(pgon_i => {
                const posis_i = this.modeldata.geom.nav.navAnyToPosi(exports.EEntType.PGON, pgon_i);
                posis_i.forEach(posi_i => {
                    ent_sets.obj_ps.add(posi_i);
                });
            });
        ...
        */
        ...
        getPgonNormal(ssid, pgon_i) {
            ...
            for (const tri_i of tris_i) {
                ...
                const xyzs = posis_i.map(posi_i => this.modeldata.attribs.attribs_maps.get(ssid).ps.get(exports.EAttribNames.COORDS).getEntVal(posi_i));
        ...
        isPosiUnused(ssid, posi_i) {
            const verts_i = this._geom_maps.up_posis_verts.get(posi_i);
            for (const vert_i of verts_i) {
                const [ent_type, ent_i] = this.modeldata.geom.query.getTopoObj(exports.EEntType.VERT, vert_i);
    ...
    class GIGeomThreejs {
        ...
        get3jsTris(ssid, vertex_map) {
            ...
            const tris_i = this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.TRI);
            for (const tri_i of tris_i) {
        ...
        get3jsEdges(ssid, vertex_map) {
            ...
            // get ents from snapshot
            const edges_i = this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.EDGE);
            for (const edge_i of edges_i) {
        ...
        get3jsPoints(ssid, vertex_map) {
            ...
            const points_i = this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.POINT);
            for (const point_i of points_i) {
                if (pgon_vr_cam_attrib) {
    ...
    class GIGeomImpExp {
        ...
        importGI(gi_data, renum_maps) {
            ...
            for (let i = 0; i < gi_data.num_posis; i++) {
                ...
                // snapshot
                this.modeldata.geom.snapshot.addNewEnt(ssid, exports.EEntType.POSI, other_posi_i);
            }
            ...
            for (let i = 0; i < gi_data.points.length; i++) {
                ...
                // timestamp
                this.modeldata.updateEntTs(exports.EEntType.POINT, other_point_i);
                // snapshot
                this.modeldata.geom.snapshot.addNewEnt(ssid, exports.EEntType.POINT, other_point_i);
            }
            // add plines to model
            for (let i = 0; i < gi_data.plines.length; i++) {
                ...
                // timestamp
                this.modeldata.updateEntTs(exports.EEntType.PLINE, other_pline_i);
                // snapshot
                this.modeldata.geom.snapshot.addNewEnt(ssid, exports.EEntType.PLINE, other_pline_i);
            }
            // add pgons to model
            for (let i = 0; i < gi_data.pgons.length; i++) {
                ...
                // timestamp
                this.modeldata.updateEntTs(exports.EEntType.PGON, other_pgon_i);
                // snapshot
                this.modeldata.geom.snapshot.addNewEnt(ssid, exports.EEntType.PGON, other_pgon_i);
            }
            // add colls to model
            for (let i = 0; i < gi_data.coll_pgons.length; i++) {
                ...
                this.modeldata.geom.snapshot.addNewEnt(ssid, exports.EEntType.COLL, other_coll_i);
    ...
    function getObjSets(model, entities, ssid) {
        ...
        for (const [ent_type, ent_i] of entities) {
            ...
            else if (ent_type === exports.EEntType.COLL) {
            ...
            for (const geom of cityobj.geometry) {
                ...
                switch (geom.type) {
                    case ECityJSONGeomType.MULTIPOINT: {
                        ...
                        _addSemanticAttribs(model, exports.EEntType.POINT, new_points_i, geom);
                        break;
                    }
                    case ECityJSONGeomType.MULTILINESTRING: {
                        ...
                        _addSemanticAttribs(model, exports.EEntType.PLINE, new_plines_i, geom);
                        break;
                    }
                    ...
                    case ECityJSONGeomType.COMPOSITESURFACE: {
                        ...
                        _addSemanticAttribs(model, exports.EEntType.PGON, new_pgons_i, geom);
    ...
    function _createGeoJSONProjection2(model, first_xyz, transform) {
        ...
        if (model.modeldata.attribs.query.hasModelAttrib('geolocation')) {
            ...
            const long_lat = proj4__default["default"](proj_from_str, 'WGS84', [x, y]);
            // change long lat
        ...
        // create projector
        const proj_obj = proj4__default["default"](proj_from_str, proj_to_str2);
        return proj_obj;
    }
    /**
    ...
    */
    ...
    function _addGeomAttribs(model, coll_i, geom) {
        model.modeldata.attribs.set.setCreateEntsAttribVal(exports.EEntType.COLL, coll_i, 'type', geom.type);
        model.modeldata.attribs.set.setCreateEntsAttribVal(exports.EEntType.COLL, coll_i, 'lod', geom.lod);
    }
    /*
    {
      "type": "MultiSurface",
    ...
    */
    ...
    function _addMaterialAttribs(model, ents_i, geom, mat_names) {
        ...
        for (const [theme_key, theme_data] of Object.entries(geom.material)) {
            ...
            for (let i = 0; i < ents_i.length; i++) {
                ...
                model.modeldata.attribs.set.setCreateEntsAttribVal(exports.EEntType.PGON, ents_i[i], 'material', mat_name);
            }
        }
    }
    /**
    ...
    function _addObjAttribs(model, coll_i, obj, id) {
        model.modeldata.attribs.set.setCreateEntsAttribVal(exports.EEntType.COLL, coll_i, 'id', id);
        model.modeldata.attribs.set.setCreateEntsAttribVal(exports.EEntType.COLL, coll_i, 'type', obj.type);
        if (obj.hasOwnProperty('children')) {
            model.modeldata.attribs.set.setCreateEntsAttribVal(exports.EEntType.COLL, coll_i, 'children', obj.children);
        }
        ...
        for (const name of Object.keys(obj.attributes)) {
            ...
            model.modeldata.attribs.set.setCreateEntsAttribVal(exports.EEntType.COLL, coll_i, name, value);
        }
    }
    /*
    "materials": [
    ...
    */
    ...
    class GIModelComparator {
        ...
        getTransPadding() {
            ...
            for (const posi_i of this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.POSI)) {
                const xyz = this.modeldata.attribs.posis.getPosiCoords(posi_i);
                if (xyz[0] < min[0]) {
                    min[0] = xyz[0];
                }
        ...
        normOpenWires(trans_padding) {
            const ssid = this.modeldata.active_ssid;
            for (const wire_i of this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.WIRE)) {
                if (!this.modeldata.geom.query.isWireClosed(wire_i)) {
                    ...
                    const verts_i = this.modeldata.geom.nav.navAnyToVert(exports.EEntType.WIRE, wire_i);
                    const fprint_start = this.normXyzFprint(exports.EEntType.VERT, verts_i[0], trans_padding);
                    const fprint_end = this.normXyzFprint(exports.EEntType.VERT, verts_i[verts_i.length - 1], trans_padding);
        ...
        normClosedWires(trans_padding) {
            ...
            for (const wire_i of this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.WIRE)) {
                if (this.modeldata.geom.query.isWireClosed(wire_i)) {
                    ...
                    const edges_i = this.modeldata.geom.nav.navAnyToEdge(exports.EEntType.WIRE, wire_i);
                    const fprints = [];
                    for (let i = 0; i < edges_i.length; i++) {
                        const edge_i = edges_i[i];
                        fprints.push([this.normXyzFprint(exports.EEntType.EDGE, edge_i, trans_padding), i]);
                    }
                    fprints.sort();
        ...
        normHoles(trans_padding) {
            const ssid = this.modeldata.active_ssid;
            for (const pgon_i of this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.PGON)) {
                const holes_i = this.modeldata.geom.query.getPgonHoles(pgon_i);
                if (holes_i.length > 0) {
                    const fprints = [];
                    for (const hole_i of holes_i) {
                        fprints.push([this.normXyzFprint(exports.EEntType.WIRE, hole_i, trans_padding), hole_i]);
                    }
                    fprints.sort();
        ...
        compareObjs(other_model, result) {
            ...
            const attrib_names = new Map();
            attrib_names.set(exports.EEntType.POSI, ['xyz']);
            if (this.modeldata.attribs.query.hasEntAttrib(exports.EEntType.VERT, 'rgb')) {
                attrib_names.set(exports.EEntType.VERT, ['rgb']);
            }
            if (this.modeldata.attribs.query.hasEntAttrib(exports.EEntType.PGON, 'material')) {
                attrib_names.set(exports.EEntType.PGON, ['material']);
            }
            // points, polylines, polygons
            const obj_ent_types = [exports.EEntType.POINT, exports.EEntType.PLINE, exports.EEntType.PGON];
        ...
        compareModelAttribs(other_model, result) {
            ...
            if (this.modeldata.attribs.query.hasEntAttrib(exports.EEntType.PGON, 'material')) {
                const pgons_i = this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.PGON);
                const pgons_mats = this.modeldata.attribs.get.getEntAttribVal(exports.EEntType.PGON, pgons_i, 'material');
                ...
                for (const this_mia_ent_i of this_mia_ents_i) {
                    ...
                    for (const other_mia_ent_i of other_mia_ents_i) {
                        ...
                        if (this_posis_i.length === other_posis_i.length) {
                            ...
                            else if (obj_ent_type === exports.EEntType.PGON) {
                                // flip the polygon
        ...
        getEntFprint(from_ent_type, index, attrib_names_map) {
            ...
            topo_ent_types_map.set(exports.EEntType.POINT, [exports.EEntType.POSI, exports.EEntType.VERT, exports.EEntType.POINT]);
            topo_ent_types_map.set(exports.EEntType.PLINE, [exports.EEntType.POSI, exports.EEntType.VERT, exports.EEntType.EDGE, exports.EEntType.WIRE, exports.EEntType.PLINE]);
            topo_ent_types_map.set(exports.EEntType.PGON, [exports.EEntType.POSI, exports.EEntType.VERT, exports.EEntType.EDGE, exports.EEntType.WIRE, exports.EEntType.PGON]);
            // create fprints of topological entities
            for (const topo_ent_type of topo_ent_types_map.get(from_ent_type)) {
                const ent_type_str = exports.EEntTypeStr[topo_ent_type];
        ...
        getCollFprints(com_idx_maps, attrib_names) {
            ...
            const colls_i = this.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.COLL);
            for (const coll_i of colls_i) {
        ...
        getCollFprint(coll_i, com_idx_maps, attrib_names) {
            const to_ent_types = [exports.EEntType.POINT, exports.EEntType.PLINE, exports.EEntType.PGON];
            const fprints = [];
            const attribs_vals = [];
            // for each attrib, make a finderprint of the attrib value
            if (attrib_names !== undefined) {
                for (const attrib_name of attrib_names) {
                    const attrib_value = this.modeldata.attribs.get.getEntAttribVal(exports.EEntType.COLL, coll_i, attrib_name);
                    if (attrib_value !== null && attrib_value !== undefined) {
            ...
            for (const to_ent_type of to_ent_types) {
                ...
                const ents_i = this.modeldata.geom.nav.navAnyToAny(exports.EEntType.COLL, to_ent_type, coll_i);
                const com_idxs = [];
                for (const ent_i of ents_i) {
    ...
    class GIModelThreejs {
        ...
        _generateColors() {
            const colors = [];
            const num_ents = this.modeldata.geom.query.numEnts(exports.EEntType.VERT);
    ...
    class GIModelData {
        ...
        importGI(model_data) {
            ...
            const ents = [];
            renum_maps.points.forEach((new_ent_i, _) => ents.push([exports.EEntType.POINT, new_ent_i]));
            renum_maps.plines.forEach((new_ent_i, _) => ents.push([exports.EEntType.PLINE, new_ent_i]));
            renum_maps.pgons.forEach((new_ent_i, _) => ents.push([exports.EEntType.PGON, new_ent_i]));
            renum_maps.colls.forEach((new_ent_i, _) => ents.push([exports.EEntType.COLL, new_ent_i]));
        ...
        getObjsUpdateTs(ent_type, ent_i) {
            ...
            switch (ent_type) {
                ...
                case exports.EEntType.PLINE:
                case exports.EEntType.PGON:
                    this.attribs.set.setEntAttribVal(ent_type, ent_i, exports.EAttribNames.TIMESTAMP, ts);
                    return;
                case exports.EEntType.COLL:
                    // get the objects from the collection
                    this.geom.nav.navCollToPgon(ent_i).forEach(pgon_i => {
                        this.attribs.set.setEntAttribVal(exports.EEntType.PGON, pgon_i, exports.EAttribNames.TIMESTAMP, ts);
                    });
                    this.geom.nav.navCollToPline(ent_i).forEach(pline_i => {
                        this.attribs.set.setEntAttribVal(exports.EEntType.PLINE, pline_i, exports.EAttribNames.TIMESTAMP, ts);
                    });
                    this.geom.nav.navCollToPoint(ent_i).forEach(point_i => {
                        this.attribs.set.setEntAttribVal(exports.EEntType.POINT, point_i, exports.EAttribNames.TIMESTAMP, ts);
                    });
                    return;
                case exports.EEntType.WIRE:
                case exports.EEntType.EDGE:
        ...
        getObjsCheckTs(ent_type, ent_i) {
            ...
            switch (ent_type) {
                ...
                case exports.EEntType.PLINE:
                case exports.EEntType.PGON:
                    if (this.attribs.get.getEntAttribVal(ent_type, ent_i, exports.EAttribNames.TIMESTAMP) !== ts) {
                ...
                case exports.EEntType.COLL:
                    // get the objects from the collection
                    this.geom.nav.navCollToPgon(ent_i).forEach(pgon_i => {
                        this.getObjsCheckTs(exports.EEntType.PGON, pgon_i);
                    });
                    this.geom.nav.navCollToPline(ent_i).forEach(pline_i => {
                        this.getObjsCheckTs(exports.EEntType.PLINE, pline_i);
                    });
                    this.geom.nav.navCollToPoint(ent_i).forEach(point_i => {
                        this.getObjsCheckTs(exports.EEntType.POINT, point_i);
                    });
                    return;
                case exports.EEntType.WIRE:
                case exports.EEntType.EDGE:
        ...
        updateEntTs(ent_type, ent_i) {
            if (ent_type >= exports.EEntType.POINT && ent_type <= exports.EEntType.PGON) {
                this.attribs.set.setEntAttribVal(ent_type, ent_i, exports.EAttribNames.TIMESTAMP, this.active_ssid);
            }
        }
        /**
        ...
        getEntTs(ent_type, ent_i) {
            ...
            return this.attribs.get.getEntAttribVal(ent_type, ent_i, exports.EAttribNames.TIMESTAMP);
        }
        /**
    ...
    function processMaterialPgon(model, pgon_i, has_color_attrib, materials_map, material_effects_map, materials_rev_map) {
        const pgon_verts_i = model.modeldata.geom.nav.navAnyToVert(exports.EEntType.PGON, pgon_i);
        let material_id = 'default_pgon_material';
        if (has_color_attrib) {
            let color = [0, 0, 0];
            for (const pgon_vert_i of pgon_verts_i) {
                let vert_color = model.modeldata.attribs.get.getEntAttribVal(exports.EEntType.VERT, pgon_vert_i, exports.EAttribNames.COLOR);
    ...
    function processMaterialPline(model, pline_i, has_color_attrib, materials_map, material_effects_map, materials_rev_map) {
        const pline_verts_i = model.modeldata.geom.nav.navAnyToVert(exports.EEntType.PLINE, pline_i);
        let material_id = 'default_pline_material';
        if (has_color_attrib) {
            let color = [0, 0, 0];
            for (const pline_vert_i of pline_verts_i) {
                let vert_color = model.modeldata.attribs.get.getEntAttribVal(exports.EEntType.VERT, pline_vert_i, exports.EAttribNames.COLOR);
                if (vert_color === null || vert_color === undefined) {
                    vert_color = [1, 1, 1];
                }
                color = [color[0] + vert_color[0], color[1] + vert_color[1], color[2] + vert_color[2]];
    ...
    function processGeomMeshPline(model, pline_i, material_id, geom_meshes_map) {
        ...
        let indices = '';
        const pline_edges_i = model.modeldata.geom.nav.navAnyToEdge(exports.EEntType.PLINE, pline_i);
        let num_edges = 0;
        for (const edge_i of pline_edges_i) {
            const edge_posis_i = model.modeldata.geom.nav.navAnyToPosi(exports.EEntType.EDGE, edge_i);
    ...
    function exportDae(model, ssid) {
        ...
        const has_color_attrib = model.modeldata.attribs.query.hasEntAttrib(exports.EEntType.VERT, exports.EAttribNames.COLOR);
        model.modeldata.attribs.query.hasEntAttrib(exports.EEntType.VERT, exports.EAttribNames.NORMAL);
        model.modeldata.attribs.query.hasEntAttrib(exports.EEntType.VERT, exports.EAttribNames.TEXTURE);
        ...
        const pgons_i = model.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.PGON);
        for (const pgon_i of pgons_i) {
        ...
        const plines_i = model.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.PLINE);
        for (const pline_i of plines_i) {
...
`;
    ...
    function _createGeojsonPolygon(model, pgon_i, proj_obj, rot_matrix, flatten) {
        ...
        // }
        const all_coords = [];
        const wires_i = model.modeldata.geom.nav.navAnyToWire(exports.EEntType.PGON, pgon_i);
        for (let i = 0; i < wires_i.length; i++) {
            const coords = [];
            const posis_i = model.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, wires_i[i]);
            for (const posi_i of posis_i) {
                const xyz = model.modeldata.attribs.posis.getPosiCoords(posi_i);
        ...
        const all_props = {};
        for (const name of model.modeldata.attribs.getAttribNames(exports.EEntType.PGON)) {
            if (!name.startsWith('_')) {
                all_props[name] = model.modeldata.attribs.get.getEntAttribVal(exports.EEntType.PGON, pgon_i, name);
            }
        }
        return {
            'type': 'Feature',
    ...
    function _createGeojsonLineString(model, pline_i, proj_obj, rot_matrix, flatten) {
        ...
        const posis_i = model.modeldata.geom.nav.navAnyToPosi(exports.EEntType.WIRE, wire_i);
        for (const posi_i of posis_i) {
            const xyz = model.modeldata.attribs.posis.getPosiCoords(posi_i);
            const lat_long = _xformFromXYZToLongLat(xyz, proj_obj, rot_matrix);
            coords.push(lat_long);
        ...
        const all_props = {};
        for (const name of model.modeldata.attribs.getAttribNames(exports.EEntType.PLINE)) {
            if (!name.startsWith('_')) {
                all_props[name] = model.modeldata.attribs.get.getEntAttribVal(exports.EEntType.PLINE, pline_i, name);
            }
        }
        return {
            'type': 'Feature',
    ...
    */
    ...
    function _createProjection(model) {
        ...
        const proj_obj = proj4__default["default"](proj_from_str, proj_to_str);
        return proj_obj;
    }
    /*
        "geometry": {
    ...
    */
    ...
    function _addPointToModel(model, point, proj_obj, rot_matrix, elevation) {
        ...
        // add attribs
        _addAttribsToModel(model, exports.EEntType.POINT, point_i, point);
        // return the index
        return point_i;
    }
    /*
    ...
    */
    ...
    function _addPlineToModel(model, linestring, proj_obj, rot_matrix, elevation) {
        ...
        // add attribs
        _addAttribsToModel(model, exports.EEntType.PLINE, pline_i, linestring);
        // return the index
        return pline_i;
    }
    /*
    ...
    */
    ...
    function _addPgonToModel(model, polygon, proj_obj, rot_matrix, elevation) {
        ...
        // add attribs
        _addAttribsToModel(model, exports.EEntType.PGON, pgon_i, polygon);
        // return the index
        return pgon_i;
    }
    /*
    ...
    */
    ...
    function _addPointCollToModel(model, multipoint, proj_obj, rot_matrix, elevation) {
        ...
        // add attribs
        _addAttribsToModel(model, exports.EEntType.COLL, coll_i, multipoint);
    ...
    */
    ...
    function _addPlineCollToModel(model, multilinestring, proj_obj, rot_matrix, elevation) {
        ...
        // add attribs
        _addAttribsToModel(model, exports.EEntType.COLL, coll_i, multilinestring);
        // return the indices of the plines and the index of the collection
    ...
    */
    ...
    function _addPgonCollToModel(model, multipolygon, proj_obj, rot_matrix, elevation) {
        ...
        // add attribs
        _addAttribsToModel(model, exports.EEntType.COLL, coll_i, multipolygon);
        // return the indices of the plines and the index of the collection
    ...
    function _convertThreeJS(model, entities, ssid) {
        ...
        const verts_xyz_buffer = new three__namespace.Float32BufferAttribute(threejs_data.verts_xyz, 3);
        const normals_buffer = new three__namespace.Float32BufferAttribute(threejs_data.normals, 3);
        const colors_buffer = new three__namespace.Float32BufferAttribute(threejs_data.colors, 3);
    ...
    function _addTris(scene, tris_i, posis_buffer, colors_buffer, normals_buffer, material_groups, materials) {
        ...
        const colorf = new three__namespace.Color(parseInt('0xFFFFFF', 16));
        const colorb = new three__namespace.Color(parseInt('0xDDDDDD', 16));
        geom.clearGroups();
        ...
        for (; index < l; index++) {
            ...
            if (index === 0) {
                ...
                mat = new three__namespace.MeshPhongMaterial(element);
            }
            else if (index === 1) {
                delete element.type;
                ...
                if (element.type === MaterialType.MeshBasicMaterial) {
                    delete element.type;
                    mat = new three__namespace.MeshBasicMaterial(element);
                }
                    ...
                    // }
                    mat = new three__namespace.MeshPhysicalMaterial(element);
                }
                else if (element.type === MaterialType.MeshLambertMaterial) {
                    delete element.type;
                    mat = new three__namespace.MeshLambertMaterial(element);
                }
                else if (element.type === MaterialType.MeshStandardMaterial) {
                    delete element.type;
                    mat = new three__namespace.MeshStandardMaterial(element);
                }
            }
            material_arr.push(mat);
        }
        const mesh = new three__namespace.Mesh(geom, material_arr);
        mesh.name = 'obj_tri';
    ...
    */
    function _addLines(scene, lines_i, posis_buffer, color_buffer, material_groups, materials) {
        ...
        const line = new three__namespace.LineSegments(newGeom, material_arr);
        line.name = 'obj_line';
    ...
    */
    function _addPoints(scene, points_i, posis_buffer, colors_buffer, color, size = 1) {
        ...
        `rgb(${color.toString()})`;
        const mat = new three__namespace.PointsMaterial({
            // color: new THREE.Color(rgb),
            size: size,
            vertexColors: true,
            sizeAttenuation: false
        });
        const point = new three__namespace.Points(geom, mat);
        point.name = 'obj_pt';
        scene.add(point);
    }
    ...
    function importObj(model, obj_str) {
        ...
        for (const coord of coords) {
            const posi_i = model.modeldata.geom.add.addPosi();
            model.modeldata.attribs.set.setEntAttribVal(exports.EEntType.POSI, posi_i, exports.EAttribNames.COORDS, coord);
        }
    ...
    function exportVertBasedObj(model, entities, ssid) {
        ...
        // do we have color, texture, normal?
        const has_color_attrib = model.modeldata.attribs.query.hasEntAttrib(exports.EEntType.VERT, exports.EAttribNames.COLOR);
        const has_normal_attrib = model.modeldata.attribs.query.hasEntAttrib(exports.EEntType.VERT, exports.EAttribNames.NORMAL);
        const has_texture_attrib = model.modeldata.attribs.query.hasEntAttrib(exports.EEntType.VERT, exports.EAttribNames.TEXTURE);
        ...
        for (let i = 0; i < verts_i.length; i++) {
            ...
            if (has_color_attrib) {
                let color = model.modeldata.attribs.get.getEntAttribVal(exports.EEntType.VERT, vert_i, exports.EAttribNames.COLOR);
                if (color === undefined) {
                    color = [1, 1, 1];
                }
        ...
        // polygons, f
        const [keys_pgons, map_colls_to_pgons] = _getGroups(model, exports.EEntType.PGON, pgons_i);
        // polygons, f
        for (const key of keys_pgons) {
            ...
            for (const pgon_i of group_pgons_i) {
                const pgon_verts_i_outer = model.modeldata.geom.nav.navAnyToVert(exports.EEntType.PGON, pgon_i);
        ...
        // polylines, l
        const [keys_plines, map_colls_to_plines] = _getGroups(model, exports.EEntType.PLINE, plines_i);
        ...
        for (let i = 0; i < posis_i.length; i++) {
            ...
            if (has_color_attrib) {
                ...
                for (const posi_vert_i of posi_verts_i) {
                    let vert_color = model.modeldata.attribs.get.getEntAttribVal(exports.EEntType.VERT, posi_vert_i, exports.EAttribNames.COLOR);
    ...
    function _getTexturesStr(model, verts_i, has_texture_attrib) {
        ...
        if (has_texture_attrib) {
            for (let i = 0; i < verts_i.length; i++) {
                const vert_i = verts_i[i];
                const texture = model.modeldata.attribs.get.getEntAttribVal(exports.EEntType.VERT, vert_i, exports.EAttribNames.TEXTURE);
    ...
    function _getNormalsStr(model, verts_i, has_normal_attrib) {
        ...
        if (has_normal_attrib) {
            for (let i = 0; i < verts_i.length; i++) {
                const vert_i = verts_i[i];
                const normal = model.modeldata.attribs.get.getEntAttribVal(exports.EEntType.VERT, vert_i, exports.EAttribNames.NORMAL);
                if (normal !== undefined) {
    ...
    function _getGroups(model, ent_type, ents_i) {
        ...
        if (!model.modeldata.attribs.query.hasEntAttrib(exports.EEntType.COLL, 'name')) {
        ...
        for (const ent_i of ents_i) {
            ...
            const names = model.modeldata.attribs.get.getEntAttribVal(exports.EEntType.COLL, Array.from(set_all_colls_i), 'name');
            let key = NOGROUPS;
            if (names.length > 0) {
                names.sort();
                key = names.join('-');
    ...
    function _getPgonsPlines(model, entities, ssid) {
        ...
        let plines_i = [];
        if (entities === null) {
            pgons_i = model.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.PGON);
            plines_i = model.modeldata.geom.snapshot.getEnts(ssid, exports.EEntType.PLINE);
        }
        else {
            for (const [ent_type, ent_i] of entities) {
                if (ent_type === exports.EEntType.PGON) {
                    ...
                    for (const pgon_i of model.modeldata.geom.nav.navAnyToPgon(exports.EEntType.COLL, ent_i)) {
                        pgons_i.push(pgon_i);
                    }
                    for (const pline_i of model.modeldata.geom.nav.navAnyToPline(exports.EEntType.COLL, ent_i)) {
                        plines_i.push(pline_i);
                    }
                }
            }
    ...
    function _getVertsPosis(model, pgons_i, plines_i) {
        ...
        for (const pgon_i of pgons_i) {
            for (const vert_i of model.modeldata.geom.nav.navAnyToVert(exports.EEntType.PGON, pgon_i)) {
                verts_i.add(vert_i);
            }
            for (const posi_i of model.modeldata.geom.nav.navAnyToPosi(exports.EEntType.PGON, pgon_i)) {
                posis_i.add(posi_i);
            }
        }
        for (const pline_i of plines_i) {
            for (const vert_i of model.modeldata.geom.nav.navAnyToVert(exports.EEntType.PLINE, pline_i)) {
                verts_i.add(vert_i);
            }
            for (const posi_i of model.modeldata.geom.nav.navAnyToPosi(exports.EEntType.PLINE, pline_i)) {
                posis_i.add(posi_i);
            }
        }
    ...
    function createSingleMeshBufTjs(__model__, ents_arrs) {
        ...
        const mat_tjs = new three__namespace.MeshBasicMaterial();
        mat_tjs.side = three__namespace.DoubleSide;
        ...
        const geom_tjs = new three__namespace.BufferGeometry();
        geom_tjs.setIndex(tris_flat);
        geom_tjs.setAttribute('position', new three__namespace.Float32BufferAttribute(xyzs_flat, 3));
        const mesh = new three__namespace.Mesh(geom_tjs, mat_tjs);
    ...
    exports.LONGLAT = LONGLAT;
    exports.RE_SPACES = RE_SPACES;
    exports.TypedArrayUtils = TypedArrayUtils;
    exports.XAXIS = XAXIS;
    exports.XYPLANE = XYPLANE;
    exports.XZPLANE = XZPLANE;
    exports.YAXIS = YAXIS;
    exports.YXPLANE = YXPLANE;
    exports.YZPLANE = YZPLANE;
    exports.ZAXIS = ZAXIS;
    exports.ZXPLANE = ZXPLANE;
    exports.ZYPLANE = ZYPLANE;
    exports.area = area;
